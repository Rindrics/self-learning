...
points((PARAM_a*PARAM_K2-PARAM_K1)/(PARAM_a*PARAM_b-1), -PARAM_b*(PARAM_a*PARAM_K2-PARAM_K1)/(PARAM_a*PARAM_b-1)+PARAM_K2,pch=21)
lines(ZERO_TO_100, (PARAM_K1-ZERO_TO_100)/PARAM_a, lty=2); points(PARAM_K1,0,pch=16, xpd=T)
lines(ZERO_TO_100, (-ZERO_TO_100*PARAM_b)+PARAM_K2, lty=2); points(0, PARAM_K2,pch=16, xpd=T)
points(80,80, pch=16); arrows(80,80, 80, 70, length=0.1);arrows(80,80, 70, 80, length=0.1)
points(5,70, pch=16);arrows(5,70,0,70, length=0.1);arrows(5,70,5,80, length=0.1)
points(10,20, pch=16);arrows(10,20,20,20, length=0.1);arrows(10,20,10,30, length=0.1)
points(70,10, pch=16);arrows(70,10,70,0, length=0.1);arrows(70,10,80,10, length=0.1)
