...
1.  [解説](#orgc65e7da)
2.  [第3章 プログラムの流れの分岐](#org9f35540)
    1.  [3-1 if文](#org208c1af)
        1.  [if文・その1](#org578669e)
        2.  [奇数の判定](#org1e5b390)
3.  [第5章 配列](#org3dee95e)
    1.  [5-1 配列](#org33d234f)
        1.  [配列による成績処理](#org052204a)
        2.  [オブジェクト形式マクロ](#org25cddcb)
4.  [第9章](#orgafe9523)
    1.  [9-2 文字例の配列](#orgea0c79e)
        1.  [文字列の配列](#org47ca549)
        2.  [文字列の配列への文字列の読み込み](#orga2ad14f)
        3.  [演習9-3](#org72cc47c)
    2.  [9-3 文字例の操作](#orgc0613c1)
        1.  [文字列の長さ](#org0bfb588)
        2.  [文字列の表示](#org2040ce6)
        3.  [数字文字の出現回数](#org4500e2b)
        4.  [大文字・小文字の変換](#orgffc5833)
        5.  [文字列の配列の受け渡し](#org748423f)
    3.  [まとめ](#org8d4c7ab)
...
-   文字列の個数を3ではなく大きな数にし，それを[オブジェクト形式マクロ](#org25cddcb)で定義
...
3.  解答を見て理解できた 演習9-11
    ...
    -   文字列の配列を読み込む関数を作成する．[演習9-3](#org72cc47c)と同様に，"\[\]$"を読み込んだ時点で読み込みを中断・終了する．
    -   "\[\]$"より前に入力された全文字列を表示する．
