...
1.  [解説](#org67ee2da)
2.  [第3章 プログラムの流れの分岐](#org428c2e7)
    1.  [3-1 if文](#orged0300c)
        1.  [if文・その1](#org5849e41)
        2.  [奇数の判定](#org4dd1a82)
3.  [第5章 配列](#orga2895bc)
    1.  [5-1 配列](#org139fefa)
        1.  [配列による成績処理](#orge992b90)
        2.  [オブジェクト形式マクロ](#orge4f1ced)
4.  [第9章](#org9e716e8)
    1.  [9-2 文字例の配列](#orgcaa4bd7)
        1.  [文字列の配列](#org1e10c6b)
        2.  [文字列の配列への文字列の読み込み](#org96162b9)
        3.  [演習9-3](#org2bb2e6c)
    2.  [9-3 文字例の操作](#orgd668183)
        1.  [文字列の長さ](#org43432ac)
        2.  [文字列の表示](#orgdeee05b)
        3.  [数字文字の出現回数](#orgeae90e2)
        4.  [大文字・小文字の変換](#orgc95ef3d)
        5.  [文字列の配列の受け渡し](#org2eff809)
    3.  [まとめ](#orgbc9304b)
...
-   文字列の個数を3ではなく大きな数にし，それを[オブジェクト形式マクロ](#orge4f1ced)で定義
...
3.  解答を見て理解できた 演習9-11
    ...
    文字列の配列を読み込む関数を作成する．[演習9-3](#org2bb2e6c)と同様に，ドル記号を5つ読み込んだ時点で読み込みを中断・終了する．
