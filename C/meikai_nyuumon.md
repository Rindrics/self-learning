...
1.  [解説](#orgcd31eee)
2.  [第3章 プログラムの流れの分岐](#orgcb3a94c)
    1.  [3-1 if文](#org7b42241)
        1.  [if文・その1](#org85edffe)
        2.  [奇数の判定](#org91b0383)
3.  [第5章 配列](#org58bb4a8)
    1.  [5-1 配列](#org79dc67b)
        1.  [配列による成績処理](#org763d65e)
        2.  [オブジェクト形式マクロ](#org1768093)
4.  [第9章](#orgc99a722)
    1.  [9-2 文字例の配列](#orgd32c2ca)
        1.  [文字列の配列](#org6174f46)
        2.  [文字列の配列への文字列の読み込み](#orgec02379)
        3.  [演習9-3](#org281701a)
    2.  [9-3 文字例の操作](#orgb907b9f)
        1.  [文字列の長さ](#org88d3967)
        2.  [文字列の表示](#org3a50925)
        3.  [数字文字の出現回数](#orgc266754)
        4.  [大文字・小文字の変換](#org48ef7a3)
        5.  [文字列の配列の受け渡し](#orgbaa02cc)
    3.  [まとめ](#org5942463)
...
-   文字列の個数を3ではなく大きな数にし，それを[オブジェクト形式マクロ](#org1768093)で定義
...
3.  解答を見て理解できた 演習9-11
    ...
    文字列の配列を読み込む関数を作成する．[演習9-3](#org281701a)と同様に，ドル記号を5つ読み込んだ時点で読み込みを中断・終了する．
...
-   <a id="org6d818e9">ナル文字</a>: 値が0の文字である．8進拡張表記で表記すると'\\0'で，整数定数で表記すると0である．
