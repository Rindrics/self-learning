...
1.  [解説](#org919ab75)
2.  [第3章 プログラムの流れの分岐](#org80cad1c)
    1.  [3-1 if文](#org6e98404)
        1.  [if文・その1](#org24759f3)
        2.  [奇数の判定](#orgcb7dcf5)
3.  [第5章 配列](#orgf790b41)
    1.  [5-1 配列](#orgf3ae192)
        1.  [配列による成績処理](#org8a572e2)
        2.  [オブジェクト形式マクロ](#org15b5c19)
4.  [第9章](#org8992d44)
    1.  [9-2 文字例の配列](#org21c8678)
        1.  [文字列の配列](#orgc313ff8)
        2.  [文字列の配列への文字列の読み込み](#orgc4711b4)
        3.  [演習9-3](#org2a156a0)
    2.  [9-3 文字例の操作](#orgc3374c5)
        1.  [文字列の長さ](#org4b986da)
        2.  [文字列の表示](#orgda10d8f)
        3.  [数字文字の出現回数](#org47dd916)
        4.  [大文字・小文字の変換](#org2425764)
        5.  [文字列の配列の受け渡し](#orgd4212c7)
    3.  [まとめ](#org40473f0)
...
-   文字列の個数を3ではなく大きな数にし，それを[オブジェクト形式マクロ](#org15b5c19)で定義
...
3.  解答を見て理解できた 演習9-11
    ...
    -   文字列の配列を読み込む関数を作成する．[演習9-3](#org2a156a0)と同様に，ドル記号を5つ読み込んだ時点で読み込みを中断・終了する．
